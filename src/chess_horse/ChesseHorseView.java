...
public class ChesseHorseView extends FrameView {
    ...
    static int count = 0;
    public static int posBlack, posResult = 0;
    ...
    private void drawBlack(int x, int y, int u, int p) {
        ...
        {
            mainPanel.setComponentZOrder(jLabel6, 0);
            jLabel6.setLocation(x, y);
            jLabel6.setVisible(true);
            jLabel5.setVisible(false);
        } else {
            mainPanel.setComponentZOrder(jLabel5, 0);
    ...
    private void pintarblancos(int u, int p) {
        {
            if (p == 0) {
                if (u == 0) {
                    if (jLabel000.isVisible()) {
                        jLabel000.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 0) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel000, 0);
                        jLabel000.setVisible(true);
                        whiteHorses.add(0);
                    }
                } else if (u == 1) {
                    if (jLabel001.isVisible()) {
                        jLabel001.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 1) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel001, 0);
                        jLabel001.setVisible(true);
                        whiteHorses.add(1);
                    }
                } else if (u == 2) {
                    if (jLabel002.isVisible()) {
                        jLabel002.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 2) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel002, 0);
                        jLabel002.setVisible(true);
                        whiteHorses.add(2);
                    }
                } else if (u == 3) {
                    if (jLabel003.isVisible()) {
                        jLabel003.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 3) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel003, 0);
                        jLabel003.setVisible(true);
                        whiteHorses.add(3);
                    }
                } else if (u == 4) {
                    if (jLabel004.isVisible()) {
                        jLabel004.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 4) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel004, 0);
                        jLabel004.setVisible(true);
                        whiteHorses.add(4);
                    }
                } else if (u == 5) {
                    if (jLabel005.isVisible()) {
                        jLabel005.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 5) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel005, 0);
                        jLabel005.setVisible(true);
                        whiteHorses.add(5);
                    }
                } else if (u == 6) {
                    if (jLabel006.isVisible()) {
                        jLabel006.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 6) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel006, 0);
                        jLabel006.setVisible(true);
                        whiteHorses.add(6);
                    }
                } else if (u == 7) {
                    if (jLabel007.isVisible()) {
                        jLabel007.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 7) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel007, 0);
                        jLabel007.setVisible(true);
                        whiteHorses.add(7);
                    }
                }
            } else if (p == 1) {
                if (u == 0) {
                    if (jLabel008.isVisible()) {
                        jLabel008.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 8) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel008, 0);
                        jLabel008.setVisible(true);
                        whiteHorses.add(8);
                    }
                } else if (u == 1) {
                    if (jLabel009.isVisible()) {
                        jLabel009.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 9) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel009, 0);
                        jLabel009.setVisible(true);
                        whiteHorses.add(9);
                    }
                } else if (u == 2) {
                    if (jLabel0010.isVisible()) {
                        jLabel0010.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 10) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0010, 0);
                        jLabel0010.setVisible(true);
                        whiteHorses.add(10);
                    }
                } else if (u == 3) {
                    if (jLabel0011.isVisible()) {
                        jLabel0011.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 11) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0011, 0);
                        jLabel0011.setVisible(true);
                        whiteHorses.add(11);
                    }
                } else if (u == 4) {
                    if (jLabel0012.isVisible()) {
                        jLabel0012.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 12) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0012, 0);
                        jLabel0012.setVisible(true);
                        whiteHorses.add(12);
                    }
                } else if (u == 5) {
                    if (jLabel0013.isVisible()) {
                        jLabel0013.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 13) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0013, 0);
                        jLabel0013.setVisible(true);
                        whiteHorses.add(13);
                    }
                } else if (u == 6) {
                    if (jLabel0014.isVisible()) {
                        jLabel0014.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 14) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0014, 0);
                        jLabel0014.setVisible(true);
                        whiteHorses.add(14);
                    }
                } else if (u == 7) {
                    if (jLabel0015.isVisible()) {
                        jLabel0015.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 15) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0015, 0);
                        jLabel0015.setVisible(true);
                        whiteHorses.add(15);
                    }
                }
            } else if (p == 2) {
                if (u == 0) {
                    if (jLabel0016.isVisible()) {
                        jLabel0016.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 16) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0016, 0);
                        jLabel0016.setVisible(true);
                        whiteHorses.add(16);
                    }
                } else if (u == 1) {
                    if (jLabel0017.isVisible()) {
                        jLabel0017.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 17) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0017, 0);
                        jLabel0017.setVisible(true);
                        whiteHorses.add(17);
                    }
                } else if (u == 2) {
                    if (jLabel0018.isVisible()) {
                        jLabel0018.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 18) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0018, 0);
                        jLabel0018.setVisible(true);
                        whiteHorses.add(18);
                    }
                } else if (u == 3) {
                    if (jLabel0019.isVisible()) {
                        jLabel0019.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 19) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0019, 0);
                        jLabel0019.setVisible(true);
                        whiteHorses.add(19);
                    }
                } else if (u == 4) {
                    if (jLabel0020.isVisible()) {
                        jLabel0020.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 20) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0020, 0);
                        jLabel0020.setVisible(true);
                        whiteHorses.add(20);
                    }
                } else if (u == 5) {
                    if (jLabel0021.isVisible()) {
                        jLabel0021.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 21) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0021, 0);
                        jLabel0021.setVisible(true);
                        whiteHorses.add(21);
                    }
                } else if (u == 6) {
                    if (jLabel0022.isVisible()) {
                        jLabel0022.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 22) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0022, 0);
                        jLabel0022.setVisible(true);
                        whiteHorses.add(22);
                    }
                } else if (u == 7) {
                    if (jLabel0023.isVisible()) {
                        jLabel0023.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 23) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0023, 0);
                        jLabel0023.setVisible(true);
                        whiteHorses.add(23);
                    }
                }
            } else if (p == 3) {
                if (u == 0) {
                    if (jLabel0024.isVisible()) {
                        jLabel0024.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 24) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0024, 0);
                        jLabel0024.setVisible(true);
                        whiteHorses.add(24);
                    }
                } else if (u == 1) {
                    if (jLabel0025.isVisible()) {
                        jLabel0025.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 25) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0025, 0);
                        jLabel0025.setVisible(true);
                        whiteHorses.add(25);
                    }
                } else if (u == 2) {
                    if (jLabel0026.isVisible()) {
                        jLabel0026.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 26) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0026, 0);
                        jLabel0026.setVisible(true);
                        whiteHorses.add(26);
                    }
                } else if (u == 3) {
                    if (jLabel0027.isVisible()) {
                        jLabel0027.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 27) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0027, 0);
                        jLabel0027.setVisible(true);
                        whiteHorses.add(27);
                    }
                } else if (u == 4) {
                    if (jLabel0028.isVisible()) {
                        jLabel0028.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 280) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0028, 0);
                        jLabel0028.setVisible(true);
                        whiteHorses.add(28);
                    }
                } else if (u == 5) {
                    if (jLabel0029.isVisible()) {
                        jLabel0029.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 29) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0029, 0);
                        jLabel0029.setVisible(true);
                        whiteHorses.add(29);
                    }
                } else if (u == 6) {
                    if (jLabel0030.isVisible()) {
                        jLabel0030.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 30) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0030, 0);
                        jLabel0030.setVisible(true);
                        whiteHorses.add(30);
                    }
                } else if (u == 7) {
                    if (jLabel0031.isVisible()) {
                        jLabel0031.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 31) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0031, 0);
                        jLabel0031.setVisible(true);
                        whiteHorses.add(31);
                    }
                }
            } else if (p == 4) {
                if (u == 0) {
                    if (jLabel0032.isVisible()) {
                        jLabel0032.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 32) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0032, 0);
                        jLabel0032.setVisible(true);
                        whiteHorses.add(32);
                    }
                } else if (u == 1) {
                    if (jLabel0033.isVisible()) {
                        jLabel0033.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 33) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0033, 0);
                        jLabel0033.setVisible(true);
                        whiteHorses.add(33);
                    }
                } else if (u == 2) {
                    if (jLabel0034.isVisible()) {
                        jLabel0034.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 34) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0034, 0);
                        jLabel0034.setVisible(true);
                        whiteHorses.add(34);
                    }
                } else if (u == 3) {
                    if (jLabel0035.isVisible()) {
                        jLabel0035.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 35) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0035, 0);
                        jLabel0035.setVisible(true);
                        whiteHorses.add(35);
                    }
                } else if (u == 4) {
                    if (jLabel0036.isVisible()) {
                        jLabel0036.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 36) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0036, 0);
                        jLabel0036.setVisible(true);
                        whiteHorses.add(36);
                    }
                } else if (u == 5) {
                    if (jLabel0037.isVisible()) {
                        jLabel0037.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 37) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0037, 0);
                        jLabel0037.setVisible(true);
                        whiteHorses.add(37);
                    }
                } else if (u == 6) {
                    if (jLabel0038.isVisible()) {
                        jLabel0038.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 38) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0038, 0);
                        jLabel0038.setVisible(true);
                        whiteHorses.add(38);
                    }
                } else if (u == 7) {
                    if (jLabel0039.isVisible()) {
                        jLabel0039.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 39) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0039, 0);
                        jLabel0039.setVisible(true);
                        whiteHorses.add(39);
                    }
                }
            } else if (p == 5) {
                if (u == 0) {
                    if (jLabel0040.isVisible()) {
                        jLabel0040.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 40) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0040, 0);
                        jLabel0040.setVisible(true);
                        whiteHorses.add(40);
                    }
                } else if (u == 1) {
                    if (jLabel0041.isVisible()) {
                        jLabel0041.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 41) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0041, 0);
                        jLabel0041.setVisible(true);
                        whiteHorses.add(41);
                    }
                } else if (u == 2) {
                    if (jLabel0042.isVisible()) {
                        jLabel0042.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 42) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0042, 0);
                        jLabel0042.setVisible(true);
                        whiteHorses.add(42);
                    }
                } else if (u == 3) {
                    if (jLabel0043.isVisible()) {
                        jLabel0043.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 43) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0043, 0);
                        jLabel0043.setVisible(true);
                        whiteHorses.add(43);
                    }
                } else if (u == 4) {
                    if (jLabel0044.isVisible()) {
                        jLabel0044.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 44) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0044, 0);
                        jLabel0044.setVisible(true);
                        whiteHorses.add(44);
                    }
                } else if (u == 5) {
                    if (jLabel0045.isVisible()) {
                        jLabel0045.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 45) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0045, 0);
                        jLabel0045.setVisible(true);
                        whiteHorses.add(45);
                    }
                } else if (u == 6) {
                    if (jLabel0046.isVisible()) {
                        jLabel0046.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 46) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0046, 0);
                        jLabel0046.setVisible(true);
                        whiteHorses.add(46);
                    }
                } else if (u == 7) {
                    if (jLabel0047.isVisible()) {
                        jLabel0047.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 47) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0047, 0);
                        jLabel0047.setVisible(true);
                        whiteHorses.add(47);
                    }
                }
            } else if (p == 6) {
                if (u == 0) {
                    if (jLabel0048.isVisible()) {
                        jLabel0048.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 48) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0048, 0);
                        jLabel0048.setVisible(true);
                        whiteHorses.add(48);
                    }
                } else if (u == 1) {
                    if (jLabel0049.isVisible()) {
                        jLabel0049.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 49) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0049, 0);
                        jLabel0049.setVisible(true);
                        whiteHorses.add(49);
                    }
                } else if (u == 2) {
                    if (jLabel0050.isVisible()) {
                        jLabel0050.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 50) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0050, 0);
                        jLabel0050.setVisible(true);
                        whiteHorses.add(50);
                    }
                } else if (u == 3) {
                    if (jLabel0051.isVisible()) {
                        jLabel0051.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 51) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0051, 0);
                        jLabel0051.setVisible(true);
                        whiteHorses.add(51);
                    }
                } else if (u == 4) {
                    if (jLabel0052.isVisible()) {
                        jLabel0052.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 52) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0052, 0);
                        jLabel0052.setVisible(true);
                        whiteHorses.add(52);
                    }
                } else if (u == 5) {
                    if (jLabel0053.isVisible()) {
                        jLabel0053.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 53) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0053, 0);
                        jLabel0053.setVisible(true);
                        whiteHorses.add(53);
                    }
                } else if (u == 6) {
                    if (jLabel0054.isVisible()) {
                        jLabel0054.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 54) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0054, 0);
                        jLabel0054.setVisible(true);
                        whiteHorses.add(54);
                    }
                } else if (u == 7) {
                    if (jLabel0055.isVisible()) {
                        jLabel0055.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 55) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0055, 0);
                        jLabel0055.setVisible(true);
                        whiteHorses.add(55);
                    }
                }
            } else if (p == 7) {
                if (u == 0) {
                    if (jLabel0056.isVisible()) {
                        jLabel0056.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 56) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0056, 0);
                        jLabel0056.setVisible(true);
                        whiteHorses.add(56);
                    }
                } else if (u == 1) {
                    if (jLabel0057.isVisible()) {
                        jLabel0057.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 57) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0057, 0);
                        jLabel0057.setVisible(true);
                        whiteHorses.add(57);
                    }
                } else if (u == 2) {
                    if (jLabel0058.isVisible()) {
                        jLabel0058.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 58) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0058, 0);
                        jLabel0058.setVisible(true);
                        whiteHorses.add(58);
                    }
                } else if (u == 3) {
                    if (jLabel0059.isVisible()) {
                        jLabel0059.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 59) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0059, 0);
                        jLabel0059.setVisible(true);
                        whiteHorses.add(59);
                    }
                } else if (u == 4) {
                    if (jLabel0060.isVisible()) {
                        jLabel0060.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 60) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0060, 0);
                        jLabel0060.setVisible(true);
                        whiteHorses.add(60);
                    }
                } else if (u == 5) {
                    if (jLabel0061.isVisible()) {
                        jLabel0061.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 61) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0061, 0);
                        jLabel0061.setVisible(true);
                        whiteHorses.add(61);
                    }
                } else if (u == 6) {
                    if (jLabel0062.isVisible()) {
                        jLabel0062.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 62) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0062, 0);
                        jLabel0062.setVisible(true);
                        whiteHorses.add(62);
                    }
                } else if (u == 7) {
                    if (jLabel0063.isVisible()) {
                        jLabel0063.setVisible(false);
                        for (int m = 0; m < whiteHorses.size(); m++) {
                            if (whiteHorses.get(m) == 63) whiteHorses.remove(m);
                        }
                    } else {
                        mainPanel.setComponentZOrder(jLabel0063, 0);
                        jLabel0063.setVisible(true);
                        whiteHorses.add(63);
                    }
                }
            }
    ...
    private void TableroMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TableroMouseClicked
        // Dibujar caballos manualmente
        int x = evt.getX();
        int y = evt.getY();
        int u = (x - 37) / 47;    //se empieza a enumerar desde la posicion 0
        int p = (y - 37) / 47;
        int posi = (p * 8) + u;
        if (jRadioButton1.isSelected() & !whiteHorses.contains(posi))
            drawBlack(x, y, u, p);
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        if (posResult < result.size()) {
            ...
            //coordenadas del centro de la pieza a situar
            {
                ...
                {
                    jLabel6.setLocation(i, j);
                    jLabel6.setVisible(true);
                    jLabel5.setVisible(false);
                } else {
                    jLabel5.setLocation(i, j);
                    jLabel6.setVisible(false);
                    jLabel5.setVisible(true);
                }
            }
            if (count == 0) {
                ...
                {
                    if ((posBlack - (posBlack / 8) * 8) == 0) posicioninicial = "a";
                    else if ((posBlack - (posBlack / 8) * 8) == 1) posicioninicial = "b";
                    else if ((posBlack - (posBlack / 8) * 8) == 2) posicioninicial = "c";
                    else if ((posBlack - (posBlack / 8) * 8) == 3) posicioninicial = "d";
                    else if ((posBlack - (posBlack / 8) * 8) == 4) posicioninicial = "e";
                    else if ((posBlack - (posBlack / 8) * 8) == 5) posicioninicial = "f";
                    else if ((posBlack - (posBlack / 8) * 8) == 6) posicioninicial = "g";
                    else if ((posBlack - (posBlack / 8) * 8) == 7) posicioninicial = "h";

                    if ((posBlack / 8) == 0) posicioninicial = posicioninicial + "8";
                    else {
                        if ((posBlack / 8) == 1) posicioninicial = posicioninicial + "7";
                        else if ((posBlack / 8) == 2) posicioninicial = posicioninicial + "6";
                        else if ((posBlack / 8) == 3) posicioninicial = posicioninicial + "5";
                        else if ((posBlack / 8) == 4) posicioninicial = posicioninicial + "4";
                        else if ((posBlack / 8) == 5) posicioninicial = posicioninicial + "3";
                        else if ((posBlack / 8) == 6) posicioninicial = posicioninicial + "2";
                        else if ((posBlack / 8) == 7) posicioninicial = posicioninicial + "1";
                    }
            ...
            count++;
            if (result.get(posResult) == 0) {
                jLabel000.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "a8 -");
            }

            if (result.get(posResult) == 1) {
                jLabel001.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "b8 -");
            }

            if (result.get(posResult) == 2) {
                jLabel002.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "c8 -");
            }

            if (result.get(posResult) == 3) {
                jLabel003.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "d8 -");
            }
            if (result.get(posResult) == 4) {
                jLabel004.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "e8 -");
            }
            if (result.get(posResult) == 5) {
                jLabel005.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "f8 -");
            }
            if (result.get(posResult) == 6) {
                jLabel006.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "g8 -");
            }
            if (result.get(posResult) == 7) {
                jLabel007.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "h8 -");
            }
            if (result.get(posResult) == 8) {
                jLabel008.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "a7 -");
            }
            if (result.get(posResult) == 9) {
                jLabel009.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "b7 -");
            }
            if (result.get(posResult) == 10) {
                jLabel0010.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "c7 -");
            }
            if (result.get(posResult) == 11) {
                jLabel0011.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "d7 -");
            }
            if (result.get(posResult) == 12) {
                jLabel0012.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "e7 -");
            }
            if (result.get(posResult) == 13) {
                jLabel0013.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "f7 -");
            }
            if (result.get(posResult) == 14) {
                jLabel0014.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "g7 -");
            }
            if (result.get(posResult) == 15) {
                jLabel0015.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "h7 -");
            }
            if (result.get(posResult) == 16) {
                jLabel0016.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "a6 -");
            }
            if (result.get(posResult) == 17) {
                jLabel0017.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "b6 -");
            }
            if (result.get(posResult) == 18) {
                jLabel0018.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "c6 -");
            }
            if (result.get(posResult) == 19) {
                jLabel0019.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "d6 -");
            }
            if (result.get(posResult) == 20) {
                jLabel0020.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "e6 -");
            }
            if (result.get(posResult) == 21) {
                jLabel0021.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "f6 -");
            }
            if (result.get(posResult) == 22) {
                jLabel0022.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "g6 -");
            }
            if (result.get(posResult) == 23) {
                jLabel0023.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "h6 -");
            }
            if (result.get(posResult) == 24) {
                jLabel0024.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "a5 -");
            }
            if (result.get(posResult) == 25) {
                jLabel0025.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "b5 -");
            }
            if (result.get(posResult) == 26) {
                jLabel0026.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "c5 -");
            }
            if (result.get(posResult) == 27) {
                jLabel0027.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "d5 -");
            }
            if (result.get(posResult) == 28) {
                jLabel0028.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "e5 -");
            }
            if (result.get(posResult) == 29) {
                jLabel0029.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "f5 -");
            }
            if (result.get(posResult) == 30) {
                jLabel0030.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "g5 -");
            }
            if (result.get(posResult) == 31) {
                jLabel0031.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "h5 -");
            }
            if (result.get(posResult) == 32) {
                jLabel0032.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "a4 -");
            }
            if (result.get(posResult) == 33) {
                jLabel0033.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "b4 -");
            }
            if (result.get(posResult) == 34) {
                jLabel0034.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "c4 -");
            }
            if (result.get(posResult) == 35) {
                jLabel0035.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "d4 -");
            }
            if (result.get(posResult) == 36) {
                jLabel0036.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "e4 -");
            }
            if (result.get(posResult) == 37) {
                jLabel0037.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "f4 -");
            }
            if (result.get(posResult) == 38) {
                jLabel0038.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "g4 -");
            }
            if (result.get(posResult) == 39) {
                jLabel0039.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "h4 -");
            }
            if (result.get(posResult) == 40) {
                jLabel0040.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "a3 -");
            }
            if (result.get(posResult) == 41) {
                jLabel0041.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "b3 -");
            }
            if (result.get(posResult) == 42) {
                jLabel0042.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "c3 -");
            }
            if (result.get(posResult) == 43) {
                jLabel0043.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "d3 -");
            }
            if (result.get(posResult) == 44) {
                jLabel0044.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "e3 -");
            }
            if (result.get(posResult) == 45) {
                jLabel0045.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "f3 -");
            }
            if (result.get(posResult) == 46) {
                jLabel0046.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "g3 -");
            }
            if (result.get(posResult) == 47) {
                jLabel0047.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "h3 -");
            }
            if (result.get(posResult) == 48) {
                jLabel0048.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "a2 -");
            }
            if (result.get(posResult) == 49) {
                jLabel0049.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "b2 -");
            }
            if (result.get(posResult) == 50) {
                jLabel0050.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "c2 -");
            }
            if (result.get(posResult) == 51) {
                jLabel0051.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "d2 -");
            }
            if (result.get(posResult) == 52) {
                jLabel0052.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "e2 -");
            }
            if (result.get(posResult) == 53) {
                jLabel0053.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "f2 -");
            }
            if (result.get(posResult) == 54) {
                jLabel0054.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "g2 -");
            }
            if (result.get(posResult) == 55) {
                jLabel0055.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "h2 -");
            }
            if (result.get(posResult) == 56) {
                jLabel0056.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "a1 -");
            }
            if (result.get(posResult) == 57) {
                jLabel0057.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "b1 -");
            }
            if (result.get(posResult) == 58) {
                jLabel0058.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "c1 -");
            }
            if (result.get(posResult) == 59) {
                jLabel0059.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "d1 -");
            }
            if (result.get(posResult) == 60) {
                jLabel0060.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "e1 -");
            }
            if (result.get(posResult) == 61) {
                jLabel0061.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "f1 -");
            }
            if (result.get(posResult) == 62) {
                jLabel0062.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "g1 -");
            }
            if (result.get(posResult) == 63) {
                jLabel0063.setVisible(false);
                jTextArea1.setText(jTextArea1.getText() + "\n" + "h1 -");
            }
    ...
    private void cargarResultado() {
        ...
        jLabel2.setText("Tiempo: " + time + " ms - Estados: " + Programa.memoria);
        jLabel4.setText("Solucion en " + result.size() + " movimientos");
        float efficiency = (float) whiteHorses.size() / (float) result.size();
        jLabel7.setText("Piezas a matar: " + whiteHorses.size() + ", eficiencia: " + efficiency);
    }
    ...
    private void jButton3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton3MouseClicked
        ...
        while (true) {
            ...
            h = h * 64;
            int valor = (int) h;
            int u = valor - (valor / 8) * 8;
            int p = valor / 8;
            int x = (u * 47) + 47;
            int y = (p * 47) + 47;
            if (whiteHorses.isEmpty() | !whiteHorses.contains(valor)) {
                drawBlack(x, y, u, p);
                break;
            }
        }
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        ...
        ArrayList<Integer> posiciones = new ArrayList(cantidad);
